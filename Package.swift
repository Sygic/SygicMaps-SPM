...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.21/maps-ios-28.4.21.zip",
            checksum: "190f2d17bbbbb00f5da547e5cfda97d3f6c916fe02043576746161ee4dc24e7a"
        )
    ]
)
