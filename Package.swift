...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.5/maps-ios-28.3.5.zip",
            checksum: "cedbd53164df03a8faa88514309eab78d4d55a313c3e6946c63c59dfc2d765af"
        )
    ]
)
