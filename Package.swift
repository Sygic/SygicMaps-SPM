...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.8/maps-ios-28.3.8.zip",
            checksum: "ff8fd9b2d3b5161c2a8b2d11d480820aab895602efcf52f3f4047fa669e3602d"
        )
    ]
)
