...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/41.0.1/maps-ios-41.0.1.zip",
            checksum: "3534af9644a50604ee6445d3410b41b7397559ffafe31c2c0ec15c6be53aebf5"
        )
    ]
)
