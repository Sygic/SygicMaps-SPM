...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/41.3.0/maps-ios-41.3.0.zip",
            checksum: "90fa235a6f82b10c68bd151fdaa0d14d0894595e7ede89da36a267a85e7f7047"
        )
    ]
)
