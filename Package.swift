...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/37.0.0/maps-ios-37.0.0.zip",
            checksum: "7f9c9191b87c2cbe25288023400675861e3c4d6654325c39026bd6a180db075b"
        )
    ]
)
