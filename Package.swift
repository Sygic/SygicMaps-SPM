...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.6/maps-ios-28.4.6.zip",
            checksum: "d6e9ddf75766e5c4d61e8b30df58fcd46eeb18fadc48299fb48924e0eefceacb"
        )
    ]
)
