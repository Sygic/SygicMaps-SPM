...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.9/maps-ios-28.4.9.zip",
            checksum: "5f1e78a1c6cda4bf7114f63d9d1d7ed97375c2556898441fe11ff000dd33bcd1"
        )
    ]
)
