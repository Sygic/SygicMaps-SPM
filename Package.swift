...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.2/maps-ios-28.4.2.zip",
            checksum: "302520519695c222350556ef8088d1955c0d5a5566b7780f655447aa31532dd6"
        )
    ]
)
