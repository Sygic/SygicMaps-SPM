...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.0/maps-ios-28.4.0.zip",
            checksum: "86bfd446b1ca03e650f869c51300f30b7771876e40bd1b330a5d3d94c0857845"
        )
    ]
)
