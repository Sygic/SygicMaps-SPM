...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.14/maps-ios-28.4.14.zip",
            checksum: "032baa11f7362d36592707cb7770778906b3aefa71dae935e66a9d8cfd5a3951"
        )
    ]
)
