...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/41.2.1/maps-ios-41.2.1.zip",
            checksum: "6837acfcf4f6437f0776f2d88614877a3268b5e7b316a58222e6df95e4301070"
        )
    ]
)
