...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.11/maps-ios-28.4.11.zip",
            checksum: "89bf58528fd047d8d54409f2e100395728dae9e634df927c4d09df06ab2f8d1e"
        )
    ]
)
