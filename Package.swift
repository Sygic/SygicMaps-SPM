...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.12/maps-ios-28.4.12.zip",
            checksum: "08d909f142af192d399dd9b5b8f747225d474a815b1d976fbb355fb9776e009b"
        )
    ]
)
