...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/41.1.0/maps-ios-41.1.0.zip",
            checksum: "824deb5c9343bdbd8927b454984c9c0ae5f9972da4e071ef0c6140f73e1586d6"
        )
    ]
)
