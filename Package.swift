...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/38.0.0/maps-ios-38.0.0.zip",
            checksum: "f53c57791e8edc5cf14020a7b3763260ed42c805d2f0b6d9afcf7266648df49e"
        )
    ]
)
