...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.7/maps-ios-28.3.7.zip",
            checksum: "22c78c8d4a060ab37ea0a574c026a35ec9e9fe498813a808238f48e22f091746"
        )
    ]
)
