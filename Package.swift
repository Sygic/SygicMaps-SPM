...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.9/maps-ios-28.3.9.zip",
            checksum: "a6c1f70247c337d9ae1ec7dcbc83e047b3c0b3ef1d8031a73fe5f9c7d9420e9f"
        )
    ]
)
