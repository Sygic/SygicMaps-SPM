...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.17/maps-ios-28.4.17.zip",
            checksum: "7cf6f7ca0cc2ad5d440a6a5e925b90152f76a331ee13487d7d330173ab35d843"
        )
    ]
)
