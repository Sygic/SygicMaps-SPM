...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/34.0.0/maps-ios-34.0.0.zip",
            checksum: "53ade131a6b46fcca8939c54066b0308c8463a27ab6ac3546c3b6945b38851f5"
        )
    ]
)
