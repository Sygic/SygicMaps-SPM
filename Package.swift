...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.10/maps-ios-28.4.10.zip",
            checksum: "5cd8742390f4748aa0f058b7abbf074468eb94d8222c00d60aa50c4194d12fc6"
        )
    ]
)
