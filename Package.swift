...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/36.0.1/maps-ios-36.0.1.zip",
            checksum: "4a16011fc4611402e3a7bfafbd7921b47c7b24cf585d68c53ead8959b2b4da71"
        )
    ]
)
