...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/31.0.1/maps-ios-31.0.1.zip",
            checksum: "9de1d52d8721ccabc98da821928702b6be8ac720953e3a89b2483489c07a56ec"
        )
    ]
)
