...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://repository.sygic.com/repository/maven-sygic-internal/com/sygic/sdk/maps-ios/28.3.5-dev.5/maps-ios-28.3.5-dev.5.zip",
            checksum: "f64eb54616e62aa48e6cdb6d9a9e3b7900133e86d637ab94367fcc22cf64d0ff"
        )
    ]
)
