...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/32.1.0/maps-ios-32.1.0.zip",
            checksum: "e0d3ffa70a66a3fb10eecb8cd302576d375b3f4ef619cce8704ede328dd03cea"
        )
    ]
)
