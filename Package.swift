...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/41.5.1/maps-ios-41.5.1.zip",
            checksum: "7465f4eda8236997ed0f4d0fbb6ff630740bcadfdd441dae7562e93c386f6ddf"
        )
    ]
)
