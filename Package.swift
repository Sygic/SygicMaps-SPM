...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/33.0.0/maps-ios-33.0.0.zip",
            checksum: "9be1acb335ea3026218f51ef861aad2f2b55287a3f25fa1e0e2284b33742c882"
        )
    ]
)
