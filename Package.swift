...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/32.0.1/maps-ios-32.0.1.zip",
            checksum: "5f6fd85fc9cf70abcca7e9f7b7b9d96fdcadc3788832e2154b9cd4ff57963432"
        )
    ]
)
