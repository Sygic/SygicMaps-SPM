...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.4.1.1/maps-ios-28.4.1.1.zip",
            checksum: "ef52840d39394e47d897e22e11c38305b96ae5bfa8f1e73ccfbf0ab04197448c"
        )
    ]
)
