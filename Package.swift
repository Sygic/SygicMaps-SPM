...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/41.4.0/maps-ios-41.4.0.zip",
            checksum: "7339aba6755c34a4ed81af8f4f2fd72f06b48129abe523df8dee25d0adfb3740"
        )
    ]
)
