...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/32.2.0/maps-ios-32.2.0.zip",
            checksum: "6875ee7f6f5512d49b10102b53fb28633e313e0c239e1a8d5ccace536d2993f7"
        )
    ]
)
