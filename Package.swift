...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/32.1.1/maps-ios-32.1.1.zip",
            checksum: "fa8723a1d9173979ff8efd16bed215109d2dfbbb3944575ed3cf2a9cf5d6ab55"
        )
    ]
)
